...
- Name: leaderboard-broken.spec.ts >> LeaderboardTable — BROKEN selectors (demo only) >> BREAKS: selects tab by CSS class with hash suffix
- Location: tests/e2e/leaderboard-broken.spec.ts:24:7
...
Locator: locator('.ClassFilterTabs_filterTab__140Pj').nth(1)
Expected: visible
Timeout: 3000ms
...
Call log:
  ...
  - waiting for locator('.ClassFilterTabs_filterTab__140Pj').nth(1)
