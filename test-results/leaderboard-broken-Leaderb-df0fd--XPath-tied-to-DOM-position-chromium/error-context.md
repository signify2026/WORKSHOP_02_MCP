...
- Name: leaderboard-broken.spec.ts >> LeaderboardTable — BROKEN selectors (demo only) >> BREAKS: selects leaderboard row by XPath tied to DOM position
- Location: tests/e2e/leaderboard-broken.spec.ts:39:7
...
Locator: locator('//div[contains(@class,"leaderboardContainer")]//div[2]//div[1]//span[2]')
Expected: "Emily Rodriguez"
Timeout: 3000ms
Error: element(s) not found

Call log:
  - Expect "toHaveText" with timeout 3000ms
  - waiting for locator('//div[contains(@class,"leaderboardContainer")]//div[2]//div[1]//span[2]')
